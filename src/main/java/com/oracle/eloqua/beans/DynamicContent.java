...
public class DynamicContent {
    ...
    @JsonProperty("defaultContentSection")
    private DefaultContentSection defaultContentSection;
    @JsonProperty("rules")
    private List<Rule> rules = null;
    @JsonProperty("isContentPublic")
    private Boolean isContentPublic;
