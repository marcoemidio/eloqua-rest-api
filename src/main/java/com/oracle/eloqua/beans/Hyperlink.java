...
public class Hyperlink {
    ...
    @JsonProperty("href")
    private String href;
    @JsonProperty("hyperlinkType")
    private String hyperlinkType;
    @JsonProperty("referencedEntityId")
