...
public class DefaultKeyFieldMapping {
    ...
    @JsonProperty("sourceFormFieldId")
    private String sourceFormFieldId;
    @JsonProperty("updateType")
    private String updateType;
    @JsonProperty("targetEntityFieldId")
